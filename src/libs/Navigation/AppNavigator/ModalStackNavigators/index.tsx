...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.ACCOUNTING.XERO_EXPORT_BANK_ACCOUNT]: () => require('../../../../pages/workspace/accounting/xero/export/XeroBankAccountConfigurationPage').default as React.ComponentType,
